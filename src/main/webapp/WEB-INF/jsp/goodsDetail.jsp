	...
	<div id="templatemo_main_wrapper">
		<div id="templatemo_main">
			<div id="contentt" class="float_l">
				<div class="post">
					<a href="./productpics/showpic/${pics[0].product.id}"
						alt="${pics[0].localDescription}" class="jqzoom" rel='gal1'
						title="triumph"><img
						src="./productpics/showpic/${pics[0].product.id}" class="fs"
						jqimg="./productpics/showpic/${pics[0].product.id}" id="bigImg" /></a>
					<span> <a href="./productpics/showpic/${pics[0].product.id}"
					...
					<div id="cdu-spec-list">
						<div class="cdu-spec-items"
							...
							<ul class="imgList">
								<li><c:forEach items="pics" var="pic">
										<img alt="products pictrue"
											src="./productpics/showpic/${pic.product.id}">
									</c:forEach></li>
							</ul>
				...
				<div class="goods_main">
					...
					<div class="product_parameters_info">
						...
						<table>
							...
							<tr>
								<td>Storage Method: XXXXX</td>
								<td id="product_parameters_info_right">Food Additives:
									XXXXX</td>
							</tr>
							<tr>
								<td>Place of Origin: XXXXX</td>
