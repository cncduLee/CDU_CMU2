    ...
    <div id="templatemo_main">
    	<div class="homepage_post col half float_l">
            ...
            codebase="http://fpdownload.macromedia.com/pub/shockwave  
             ...
             <embed src="media/fruit.swf" quality="high"   
                       bgcolor="#ffffff" name="mymovie"    
           ...
           <p><a href="http://www.cdu.edu.cn" target="_parent">This website</a> is made by CMU and CDU.In order to make it more convience for Chinese people to buy Thai fruits and make people buy cheaper fruit,we set up this website.People can use this web to open a on line shop or 
               buy fruit.</p>
           <a href="http://www.cdu.edu.cn" rel="nofollow"><strong>read more</strong></a>
		</div>
        
       <div class="col half float_r">
            <h2>Regulations</h2>
			<p><em>If you do not very clearly about relative rules or regulations,please click there and read it.</em></p> 
