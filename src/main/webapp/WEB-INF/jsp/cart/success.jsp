	 ...
	 <img src="images/Submit_successfully.png" alt="" style="width: 700px; height:30px; float: left;"/>
		<div class="w main">
			<div class="m m3" id="qpay">
				<div class="mc">
					...
					<div class="fore">
						...
						<ul class="list-h">
							<li class="fore1">Orders' number：362821854</li>
							<li class="fore3">Amout payable：<strong class="ftx-01">99.00元</strong></li>
			...
			<div id="qpay02" class="m">
				<div class="mt">
					<h3>
						Only after pay for<strong class="ftx-01">99.00$</strong>can you finish your order 。
					</h3>
					<div class="extra">
			...
			<div class="o-mb">
				After finish orders ,you can look over ： <a href="#" target="_blank">Order details</a> <input
